...
interface MGRSGraticuleOptions {
  projection: Projection;
  gridInterval?: number;
}

class MGRSGraticule extends VectorLayer<VectorSource> {
  private projection: Projection;
  private gridInterval: number;

  constructor(options: MGRSGraticuleOptions) {
    super({
